...
public class MethodologyDAO {
    ...
    public ArrayList<HashMap<String,String>> getLiteralsMethodology(String section, String indicator){
    	...
    	try {
    		...
    		String [] column_names = {"Indicator Name", "Description", "Data Source", "Specific table/Question", "URL/source file", "Filtering options applied", 
